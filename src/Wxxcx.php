...
class Wxxcx
{
    ...
    function __construct($config = [])
    {
        ...
        $this->appId = $config['appid'];//('wxxcx.appid', '');
        $this->secret = $config['secret'];//config('wxxcx.secret', '');
        $this->code2session_url = $config['code2session_url'];//config('wxxcx.code2session_url', '');
    }
